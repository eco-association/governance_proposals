...
contract TrusteePayout2 is Proposal {
    ...
    function enacted(address _self) public virtual override{
        ...
        address[] memory _recipients = TrusteePayout2(_self).returnRecipients();
        uint256[] memory _payouts = TrusteePayout2(_self).returnPayouts();
